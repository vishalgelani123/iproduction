                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_25"><?php echo app('translator')->get('index.currency'); ?></th>
                                <th class="ir_w_16"><?php echo app('translator')->get('index.conversion_rate'); ?></th>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        <?php if(routePermission('currency.edit')): ?>
                                            <a href="<?php echo e(url('currency')); ?>/<?php echo e(encrypt_decrypt($value->id, 'encrypt')); ?>/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="<?php echo app('translator')->get('index.edit'); ?>"><i class="fa fa-edit tiny-icon"></i></a>
                                        <?php endif; ?>
                                        <?php if(routePermission('currency.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('currency.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\iproduction_null\resources\views/pages/currency/index.blade.php ENDPATH**/ ?>