                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        @if (routePermission('productwaste.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('product-wastes.destroy', $value->id) }}"
