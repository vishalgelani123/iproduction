        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                ...
                {!! Form::model(isset($obj) && $obj ? $obj : '', [
                    ...
                    'route' => ['units.update', isset($obj->id) && $obj->id ? $obj->id : ''],
                ]) !!}
                @csrf
                <div>
                    <div class="row">
                ...
                <div class="row mt-2">
                    <div class="col-sm-12 col-md-6 mb-2 d-flex gap-3">
                        ...
                        <a class="btn bg-second-btn" href="{{ route('units.index') }}"><iconify-icon icon="solar:round-arrow-left-broken"></iconify-icon>@lang('index.back')</a>
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
