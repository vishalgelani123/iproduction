                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_25">@lang('index.name')</th>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        @if (routePermission('units.edit'))
                                            <a href="{{ url('units') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('units.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('units.destroy', $value->id) }}"
