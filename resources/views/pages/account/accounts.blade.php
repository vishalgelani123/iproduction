                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_13_p">@lang('index.account_name')</th>
                                <th class="width_13_p">@lang('index.balance')</th>
                                <th class="width_20_p">@lang('index.description')</th>
                                <th class="width_26_p">@lang('index.added_by')</th>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        @if (routePermission('account.edit'))
                                            <a href="{{ url('accounts') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('account.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('accounts.destroy', $value->id) }}"
