...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        <div class="table-box">
            <!-- form start -->
            {{Form::model($customerOrder,['route'=>['customer-orders.update',$customerOrder->id],'method'=>'put', 'id' => "customer_order_form"])}}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                <label class="control-label">@lang('index.type')<span class="ir_color_red"> *</span></label>
                                <div>
                                    <select class="form-control select2" name="invoice_type" id="invoice_type" placeholder="@lang('index.invoice_type')">
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                <label class="control-label">@lang('index.paid_amount') <span class="required_star">*</span></label>
                                <div>
                                    <input type="number" class="form-control" name="paid_amount" id="paid_amount" placeholder="@lang('index.paid_amount')" value="" required="">
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control" id="due_amount" name="due_amount" placeholder="@lang('index.due_amount')" value="">
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control" id="order_due_amount" name="order_due_amount" placeholder="@lang('index.order_due_amount')" value="">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn bg-blue-btn invoice_submit"><iconify-icon icon="solar:check-circle-broken"></iconify-icon> @lang('index.submit')</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="deliveryModal" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                <label class="control-label">@lang('index.product')<span class="ir_color_red"> *</span></label>
                                <div>
                                    {!! Form::select('product_id', $product, null, ['class'=>'form-control select2', 'id'=>'product_id',  'placeholder'=>'Please Select', 'required']) !!}
                                </div>
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="quantity" id="delivary_quantity" placeholder="Quantity" value="" required="">
                                </div>
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                <label class="control-label">@lang('index.delivery_date') <span class="required_star">*</span></label>
                                <div>
                                    <input type="text" class="form-control customDatepicker" id="ddelivery_date" name="delivery_date" placeholder="Delivery Date" readonly="" required="">
                                </div>
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                <label class="control-label">@lang('index.delivery_status') <span class="required_star">*</span></label>
                                <div>
                                    <select class="form-control select2" name="delivery_status" id="delivery_status" placeholder="Please Select" required="">
                        ...
                        <div class="col-sm-12 col-md-6 mb-2">
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea tabindex="4" class="form-control" rows="4" name="delivery_note" placeholder="Delivery Note ..."></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <input type="hidden" name="customer_order_id" value="{{@$customerOrder->id}}">
                <button type="submit" class="btn bg-blue-btn delivaries_button"><iconify-icon icon="solar:check-circle-broken"></iconify-icon> @lang('index.submit')</button>
            </div>
        </div>
    </div>
</div>
