        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                ...
                {!! Form::model(isset($obj) && $obj ? $obj : '', [
                    ...
                    'route' => ['rawmaterialpurchases.update', isset($obj->id) && $obj->id ? $obj->id : ''],
                ]) !!}
                @csrf
                <div>
                    <div class="row">
                        <div class="col-sm-12 mb-2 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="reference_no" id="reference_no"
                                    ...
                                    value="{{ isset($obj->reference_no) ? $obj->reference_no : $ref_no }}" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror select2" name="type"
                                    ...
                                    <option value="purchase"
                                        {{ (isset($obj->type) && $obj->type == 'purchase') || old('type') == 'purchase' ? 'selected' : '' }}>
                                        @lang('index.purchases')</option>
                                    <option value="purchase_order"
                                        {{ (isset($obj->type) && $obj->type == 'purchase_order') || old('type') == 'purchase_order' ? 'selected' : '' }}>
                                        @lang('index.purchase_order')</option>
                                </select>
                            </div>
                            <div class="text-danger d-none"></div>
                            @error('type')
                            ...
                            <div class="form-group">
                                ...
                                <select tabindex="4"
                                    ...
                                    @foreach ($rmaterials as $rm)
                                        <option
                                            value="{{ $rm->id . '|' . $rm->name . ' (' . $rm->code . ')|' . $rm->name . '|' . $rm->rate_per_unit . '|' . getPurchaseSaleUnitById($rm->unit) . '|' . $setting->currency }}">
                            ...
                            <div class="form-group ">
                                @if (!isset($pruchse_rmaterials))
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#productionProductModal"
