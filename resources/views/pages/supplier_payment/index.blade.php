                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        @if (routePermission('supplier-payment.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('supplier-payment.destroy', $value->id) }}"
