                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_13_p">@lang('index.name')</th>
                                <th class="width_26_p">@lang('index.description')</th>
                                <th class="width_13_p">@lang('index.added_by')</th>
                                <th class="width_13_p ir_txt_center">@lang('index.actions')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($obj && !empty($obj))
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        @if (routePermission('noi.edit'))
                                            <a href="{{ url('noninventoryitems') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit"
                                                class="button-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('noi.delete'))
