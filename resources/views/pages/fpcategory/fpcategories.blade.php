                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p ir_txt_center">@lang('index.actions')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($obj && !empty($obj))
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        @if (routePermission('productcategory.edit'))
                                            <a href="{{ url('fpcategories') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit"
                                                class="button-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('productcategory.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('fpcategories.destroy', $value->id) }}"
