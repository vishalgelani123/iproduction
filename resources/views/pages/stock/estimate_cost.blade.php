...
<body>
    <div class="m-auto b-r-5 p-30">
        ...
        <div class="text-center pt-10 pb-10">
            <h2 class="color-000000 pt-20 pb-20">@lang('index.estimate_cost_date')</h2>
        </div>
        <table>
            <tr>
                <td class="w-50">
        ...
        <table class="w-100 mt-20">
            <thead class="b-r-3 bg-color-000000">
                <tr>
                    ...
                    <th class="w-5">@lang('index.quantity')</th>
                    <th class="w-45">@lang('index.costing')</th>
                    <th class="w-25">@lang('index.required_time')</th>
                </tr>
            </thead>
            <tbody>
                @if (isset($productData) && $productData)
                    @foreach ($productData as $key => $value)
                        ...
                        <tr class="rowCount">
                            ...
                            <td>{!! urldecode($value['cost']) !!}</td>
                            <td class="text-center">{{ $value['required_time'] }}
                            </td>
                        </tr>
                    @endforeach
                @endif
