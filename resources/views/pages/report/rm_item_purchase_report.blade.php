                ...
                <table id="datatable" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="w-10">@lang('index.reference_no')</th>
                            <th class="w-5">@lang('index.date')</th>
                            <th class="w-10">@lang('index.supplier')</th>
                            <th class="w-10">@lang('index.g_total')</th>
                            <th class="w-10">@lang('index.paid')</th>
                            <th class="w-10">@lang('index.due')</th>
                            <th class="w-40">@lang('index.items')</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($obj && !empty($obj))
                        ...
                        <tr>
                            ...
                            <td>{!! getRMPurchaseItems($value->id) !!}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
