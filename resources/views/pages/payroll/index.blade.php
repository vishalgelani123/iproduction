                        ...
                        <tbody>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td>IQD {{($value->total_amount) }}</td>
                                    <td>{{ $value->accountName->name ?? 'N/A' }}</td>
                                    <td>{{ $value->addedBy->name ?? '' }}</td>
                                    <td class="ir_txt_center">
                                        @if (routePermission('payroll.edit'))
                                            <a href="{{ url('payroll') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('payroll.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('payroll.destroy', $value->id) }}"
...
@section('script')
    ...
    <script src="{!! $baseURL . 'frequent_changing/js/payroll.js' !!}"></script>
@endsection
