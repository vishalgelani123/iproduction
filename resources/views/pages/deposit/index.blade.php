                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_10_p">@lang('index.deposit_withdraw')</th>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        @if (routePermission('deposit.edit'))
                                            <a href="{{ url('deposit') }}/{{ encrypt_decrypt($value->id, 'encrypt') }}/edit" class="button-success"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="@lang('index.edit')"><i class="fa fa-edit tiny-icon"></i></a>
                                        @endif
                                        @if (routePermission('deposit.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('deposit.destroy', $value->id) }}"
