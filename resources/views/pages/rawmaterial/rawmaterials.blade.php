                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="width_20_p">@lang('index.name')</th>
                                <th class="width_10_p">@lang('index.code')</th>
                                <th class="width_10_p">@lang('index.category')</th>
                                <th class="width_12_p">@lang('index.unit')</th>
                                <th class="width_12_p">@lang('index.rate_per_unit')</th>
                                <th class="width_10_p">@lang('index.consumption_unit')</th>
                                <th class="width_10_p">@lang('index.conversion_rate')</th>
                                <th class="width_5_p">@lang('index.rate_per_consumption_unit')</th>
                                <th class="width_10_p">@lang('index.opening_stock')</th>
