 ...
 * @Email   <mailto:abdullah@almsaeedstudio.com>
 * @version 2.4.0
...
+(function (a) {
        ...
        (g.prototype.activate = function () {
            ...
            (g.prototype.fix = function () {
                ...
                if (a("body").hasClass(f.fixed))
                    ...
                    var h;
                    d >= g
                        ? (a(e.contentWrapper).css("min-height", d - c),
                          (h = d - c))
    ...
    (function (a) {
        ...
        (h.prototype.init = function () {
            (this.options.expandOnHover ||
                a("body").is(e.mini + e.layoutFixed)) &&
    ...
    (function (a) {
        ...
        (g.prototype.toggle = function (a) {
            if (
                (a.parents(e.li).first().toggleClass(f.done),
                !a.prop("checked"))
            )
